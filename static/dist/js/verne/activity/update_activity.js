  ...
  function open_modal_delete_activity(url) {
      $('#Modaldelete').load(url, function() {
  ...
  function open_modal_score_activity(url) {
      $('#Modalscore').load(url, function() {
...
$('#activate_select_editar_idea_multiple').select2({
  ...
  // ----------------------------------------------------
  $('#activate_select_editar_multiple').select2({
...
if (document.getElementById("abrir_modal_creacion")) {
  document.getElementById("abrir_modal_creacion").addEventListener("click", function () {
      abrir_modal_creacion('/activity/task_create/');
  });
}
  ...
  let table = $('#tabla_listar').DataTable({
      ...
      "columns": [
...

          {
              ...
              'width': '30%',
              render: function (data, type, row) {
                  return '<div class="row justify-content-center"><div class="col-6 col-xl-6 col-lg-6 col-sm-6 text-right"><button id="editar_lista_' + row.task__id + '"' + 'type="button" class="btn btn-info " onclick="abrir_modal_edicion(\'/activity/task_update/' + row.task__id + '/\');"><i class="fa fa-edit fa-1x"></i></button></div>' + '<div class="col-6 col-xl-6 col-lg-6 col-sm-6 text-left"><button id="eliminar_lista_' + row.task__id + '"' + 'type="button" class="btn btn-danger" onclick="abrir_modal_eliminacion(\'/activity/task_delete/' + row.task__id + '/\');"><i class="fas fa-trash-alt fa-1x"></button></div></div>';
                  //return 'hola'
              },
...
BuscarPorNombreModeloMultipleEmail('#activate_select_users_edit', '/activity/buscar_usuario/')
BuscarPorNombreModeloMultipleEmail('#activate_select_edit_idea', '/activity/buscar_idea/')
